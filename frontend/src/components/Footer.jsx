        ...
        <div className="footer-content">
          <div className="footer-section">
            ...
            <div className="social-links">
              <a href="https://github.com/ctoriola" title="GitHub" target="_blank" rel="noopener noreferrer">
              ...
              <a href="https://github.com/ctoriola/NCrypt#readme" title="Documentation" target="_blank" rel="noopener noreferrer">
